...
//    private static final String TAG = "JCameraView";
    ...
    //是否开启多拍
    private boolean enableMultiPicture;
    ...
    private void initView() {
        ...
        ivFinish = view.findViewById(R.id.image_finish);
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setEnableMultiPicture(boolean enable) {
        this.enableMultiPicture = enable;
    }

    public boolean isEnableMultiPicture() {
        return enableMultiPicture;
    }
    ...
    public void setFinishShow(boolean b) {
        ivFinish.setVisibility(b ? View.VISIBLE : View.GONE);
    }
    ...
    public void setLeftImage(Bitmap bitmap) {
        mCaptureLayout.setLeftImage(bitmap);
    }

    public void setLeftImage(Drawable drawable) {
        mCaptureLayout.setLeftImage(drawable);
    }
    ...
    public void setFinishClickListener(OnClickListener clickListener) {
        ivFinish.setOnClickListener(clickListener);
    }
