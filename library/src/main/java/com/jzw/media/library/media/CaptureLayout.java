...
import com.jzw.media.library.media.listener.ReturnListener;
...
//                resetCaptureLayout();
        ...
        iv_custom_right.setScaleType(ImageView.ScaleType.CENTER_CROP);
    ...
    public void setLeftImage(Drawable drawable) {
        iv_custom_left.setImageDrawable(drawable);
    }
