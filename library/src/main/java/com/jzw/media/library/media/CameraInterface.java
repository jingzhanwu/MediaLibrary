...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    protected static final int TYPE_RECORDER = 0x090;
    protected static final int TYPE_CAPTURE = 0x091;
    ...
    protected void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp) {
...
//
        Log.i("jzw", angle + " = " + cameraAngle + " = " + nowAngle);
...
//        }
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("JZW", "startRecord IllegalStateException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (IOException e) {
            e.printStackTrace();
            Log.i("JZW", "startRecord IOException");
            if (this.errorLisenter != null) {
                this.errorLisenter.onError();
            }
        } catch (RuntimeException e) {
            Log.i("JZW", "startRecord RuntimeException");
        }
    }
